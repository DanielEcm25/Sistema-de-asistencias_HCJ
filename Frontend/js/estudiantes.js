...
async function registrarEstudiante(event) {
    ...
    try {
        const response = await fetch("https://ejemplofirebase.netlify.app/.netlify/functions/estudiantes", {
            method: "POST",
            headers: {
...
async function consultarEstudiante(event) {
    ...
    try {
        const response = await fetch(`https://ejemplofirebase.netlify.app/.netlify/functions/estudiantes?tipoDocumento=${tipoDocumento}&numeroDocumento=${numeroDocumento}`);
...
async function consultarAsignatura(event) {
    ...
    try {
        const response = await fetch(`https://ejemplofirebase.netlify.app/.netlify/functions/estudiantes/asignatura?codigo=${codigo}&grupo=${grupo}`);
...
async function agregarEstudianteAsignatura(event) {
    ...
    try {
        const response = await fetch("https://ejemplofirebase.netlify.app/.netlify/functions/estudiantes/asignatura", {
            method: "POST",
            headers: {
                "Content-Type": "application/json"
            },
